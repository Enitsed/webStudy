...
<body>
	<div id="wrap">
		...
		<div id="header">
			<h1>
				<a href="#"><img src="images/logo.gif" alt="이지스퍼블리싱" /></a>
			</h1>
			<dl id="util_menu">
			...
			<p id="total_btn">
				<a href="#"> <img src="images/allmenu_btn_out.gif" alt="전체 메뉴" />
				</a>
			</p>
			<div id="total_menu">
				<dl>
		...
		<div id="contents">
			<div id="contents_top">
				...
				<dl id="tabmenu">
					...
					<dd>
						<ul>
							<li><a href="#">저자문의 관련된 내용입니다.</a> <span>2014-03-01</span>
							</li>
							<li><a href="#">저자문의 관련된 내용입니다.</a> <span>2014-03-01</span>
							</li>
							<li><a href="#">저자문의 관련된 내용입니다.</a> <span>2014-03-01</span>
				...
				<ul id="consult_wrap">
					...
					<li><img src="images/banner_support.gif"
						alt="원고 양식 다운받기 및 지원 easy@easypub.co.kr" usemap="#support" /> <map
							...
							<area shape="rect" coords="9,29,126,53" href="#"
								alt="원고 양식 다운 받기" />
						</map></li>
				</ul>
			</div>
			...
			<div id="contents_bottom">
				<div id="facebook_wrap">
					<h3>
						<img src="images/facebook_title.gif" alt="페이스북" />
					</h3>
					<p>
						<iframe
							src="http://www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2FFacebookDevelopers&amp;width=285&amp;height=258&amp;colorscheme=light&amp;show_faces=true&amp;header=false&amp;stream=false&amp;show_border=false"
				...
				<div id="marketing_wrap">
					<h3>
						<img src="images/maket_title.gif" alt="마케팅" />
					</h3>
					<dl class="first">
						<dt>
					...
					<dl>
						<dt>
							<a href="#">Do it! 안드로이드 진도표와 동영상 강좌</a>
						</dt>
						<dd class="img_wrap">
							<a href="#"><img src="images/maket_img_2.gif" alt="" /></a>
						</dd>
						<dd>
							<a href="#">처음부터 끝까지 보기 힘든 초보자를 위해 섹션별 난이도를 표시해 놓았습니다.</a>
						</dd>
					</dl>
				</div>
				<div id="online_wrap">
					<h3>
						<img src="images/online_title.gif" alt="온라인 서점" />
					</h3>
					<ul>
						<li><a href="#"><img src="images/online_banner_1.gif"
								alt="배너1" /></a></li>
						<li class="fl_r"><a href="#"><img
								src="images/online_banner_2.gif" alt="배너2" /></a></li>
						<li><a href="#"><img src="images/online_banner_3.gif"
								alt="배너3" /></a></li>
						<li class="fl_r"><a href="#"><img
								src="images/online_banner_4.gif" alt="배너4" /></a></li>
						<li><a href="#"><img src="images/online_banner_5.gif"
								alt="배너5" /></a></li>
						<li class="fl_r"><a href="#"><img
								src="images/online_banner_6.gif" alt="배너6" /></a></li>
					</ul>
				</div>
			</div>
			<!-- close of contents_bottom -->
			<div id="quick_menu">
				<h3>
					<img src="images/quick_title.png" alt="퀵 메뉴" />
				</h3>
				<ul>
	...
	<div id="footer_wrap">
		<div id="inner_footer">
			...
			<dl id="bottom_menu">
				...
				<dd>
					<a href="#"><img src="images/bttom_menu_1.gif" alt="" /></a>
				</dd>
				<dd>
					<a href="#"><img src="images/bttom_menu_2.gif" alt="" /></a>
				</dd>
				<dd>
					<a href="#"><img src="images/bttom_menu_3.gif" alt="" /></a>
				</dd>
				<dd>
					<a href="#"><img src="images/bttom_menu_4.gif" alt="" /></a>
				</dd>
				<dd>
					<a href="#"><img src="images/bttom_menu_5.gif" alt="" /></a>
				</dd>
				<dd>
					<a href="#"><img src="images/bttom_menu_6.gif" alt="" /></a>
				</dd>
			</dl>
			<div id="relSite_wrap">
				<h3>
					<img src="images/rel_site_title.gif" alt="관련 사이트 이동하기" />
				</h3>
				<form action="#" method="get" name="rel_f">
					<fieldset>
						...
						</select> <input type="image" src="images/rel_site_btn.gif" alt="관련 사이트 이동" />
					</fieldset>
				</form>
			</div>
			<address>
				<img src="images/address.gif"
					alt="서울시 마포구 서교동 375-13 성지빌딩 301호, 
